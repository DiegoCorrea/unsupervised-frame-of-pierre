class Label:
    ...
    #
    REGISETRED_UNSUPERVISED = [KMEANS, BISECTING, AGGLOMERATIVE, SPECTRAL, FCM, BIRCH, OPTICS, DBSCAN]

    # REGISETRED_UNSUPERVISED = [DBSCAN, OPTICS]
    CLUSTERING_ALGORITHMS = [KMEANS, BISECTING, AGGLOMERATIVE, SPECTRAL, FCM, BIRCH]
